                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-3 sm:px-4 md:px-6 py-3 sm:py-4 whitespace-nowrap">
                            ...
                            <div class="mt-1 text-xs">
                                <div class="text-gray-600">Paid: <span class="font-semibold">TZS {{ number_format($totalPaid, 0) }}</span></div>
                                <div class="{{ $balance > 0 ? 'text-red-600' : 'text-green-600' }}">Balance: <span class="font-semibold">TZS {{ number_format($balance, 0) }}</span></div>
                            </div>
                            @endif
                        </td>
                        <td class="px-3 sm:px-4 md:px-6 py-3 sm:py-4 whitespace-nowrap">
